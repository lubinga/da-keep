...
export class NoteComponent {
  ...
  moveToTrash() {
    if (this.note.id) {
      ...
      // ID zuweisen zum späteren löschen
      // und ID löschen weil ansonsten das Objekt eine ID hat beim anlegen 
      // und das kann zu Fehlern führen da ja eine neue ID gemacht wird
